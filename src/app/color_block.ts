...
import { conf_block_size, conf_shadow_alpha, conf_shadow_blur } from './game_state';
...
const color_block = (fill_style: string, shadow_color: string) => {
...
const color_block_calc_pos = (row: number, col: number): [number, number] => [
